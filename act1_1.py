...
def eval_genomes(genomes, config):
    for genome_id, genome in genomes:
        ...
        # cv2.namedWindow("main", cv2.WINDOW_NORMAL)            # what the network sees
        ...
        while not done:
            ...
            # scaledimg = cv2.cvtColor(ob, cv2.COLOR_BGR2RGB)   # what the network sees
            ...
            # cv2.imshow('main', scaledimg)                     # what the network sees
